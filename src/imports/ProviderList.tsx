import svgPaths from "./svg-c05zer0b66";
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="ChatGPT-1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="ChatGPT-1">
          <path d={svgPaths.p1ab11dc0} fill="var(--fill-0, #222425)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame34651081() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      <ChatGpt1 />
      <p className="font-['Brown_Logitech_Pan:Bold',_sans-serif] leading-[14px] not-italic relative shrink-0 text-[#814efa] text-[14px] text-nowrap whitespace-pre">Chat GPT</p>
    </div>
  );
}
...
function Provider() {
  return (
    <div className="content-stretch flex h-[32px] items-center justify-between relative rounded-[4px] shrink-0 w-full" data-name="Provider">
      <Frame34651081 />
      <Frame34651086 />
    </div>
  );
    ...
    <div className="relative shrink-0 size-[24px]" data-name="icon/Perplexity/LogoMark">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon/Perplexity/LogoMark">
          <path clipRule="evenodd" d={svgPaths.p13ac600} fill="var(--fill-0, #20808D)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame34651088() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      <IconPerplexityLogoMark />
...
function Container() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start max-h-[192px] min-h-px min-w-px overflow-clip relative shrink-0" data-name="Container">
      <Provider />
      <Provider1 />
      <Provider2 />
      <Provider3 />
...
function ProvidersList() {
  return (
    <div className="bg-[#f2f2f2] relative shrink-0 w-full" data-name="Providers List">
...
function DeviderLine() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[10px] items-start px-0 py-[4px] relative shrink-0 w-full" data-name="Devider Line">
      <div className="bg-[#e6e6e6] h-px shrink-0 w-[166px]" />
    </div>
  );
}
...
function Button() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[8px] items-center p-[4px] relative rounded-[100px] shrink-0" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#e6e6e6] border-solid inset-0 pointer-events-none rounded-[100px]" />
      <IconOptionsAdd />
    </div>
  );
}
...
function Controls() {
  return (
    <div className="bg-[#f2f2f2] relative shrink-0 w-full" data-name="Controls">
...
export default function ProviderList() {
  return (
    <div className="bg-[#f2f2f2] content-stretch flex flex-col items-start overflow-clip relative rounded-[16px] size-full" data-name="Provider List">
      <ProvidersList />
      <Controls />
    </div>
  );
