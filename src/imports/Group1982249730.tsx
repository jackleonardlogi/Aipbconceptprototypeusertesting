import svgPaths from "./svg-879ri2ge2e";
    ...
    <div className="absolute left-0 size-[32px] top-0" data-name="icons/brand/Mic">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="icons/brand/Mic">
          ...
          <mask height="23" id="mask0_4024_3160" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }} width="14" x="9" y="5">
            <path clipRule="evenodd" d={svgPaths.p3adfd3c0} fill="var(--fill-0, white)" fillRule="evenodd" id="shape_2" />
          </mask>
          <g mask="url(#mask0_4024_3160)"></g>
        </g>
      </svg>
    </div>
  );
...
function InputField() {
  return (
    <div className="basis-0 content-stretch flex grow h-[32px] items-center min-h-px min-w-px relative shrink-0" data-name="Input Field">
...
function PrimaryButton() {
  return (
    <div className="relative size-[32px]" data-name="Primary button">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="Primary button">
          <rect fill="var(--fill-0, #814EFA)" height="32" rx="16" width="32" />
...
function PromptInput() {
  return (
    <div className="absolute bg-[rgba(242,242,242,0.88)] box-border content-stretch flex gap-[4px] h-[48px] items-center left-0 p-[8px] rounded-[24px] top-0 w-[412px]" data-name="Prompt Input">
      <Frame34651093 />
      <InputField />
      <ProviderControls />
    </div>
...
function SavedPrompt() {
  return (
    <div className="absolute bg-[rgba(245,245,245,0.84)] box-border content-stretch flex gap-[10px] h-[24px] items-center left-[8px] px-[12px] py-0 rounded-[100px] top-[54px]" data-name="Saved Prompt">
      <div className="flex flex-col font-['Brown_Logitech_Pan:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#222425] text-[14px] text-nowrap">
        <p className="leading-[18px] whitespace-pre">Rephrase</p>
      </div>
    </div>
  );
}

function SavedPrompt1() {
  return (
    <div className="absolute bg-[rgba(245,245,245,0.84)] box-border content-stretch flex gap-[10px] h-[24px] items-center left-[99px] px-[12px] py-0 rounded-[100px] top-[54px]" data-name="Saved Prompt">
      <div className="flex flex-col font-['Brown_Logitech_Pan:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#222425] text-[14px] text-nowrap">
        <p className="leading-[18px] whitespace-pre">Summarise</p>
      </div>
    </div>
  );
}

export default function Group1982249730() {
  return (
