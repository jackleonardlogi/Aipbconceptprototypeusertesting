import svgPaths from "./svg-4fccpl0bkn";

function IconOptionsUpload() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon/options+/Upload">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon/options+/Upload">
          <path clipRule="evenodd" d={svgPaths.p3b586e80} fill="var(--fill-0, #222425)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame34651081() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      <IconOptionsUpload />
      <p className="font-['Brown_Logitech_Pan:Regular',_sans-serif] leading-[20px] not-italic relative shrink-0 text-[#222425] text-[16px] text-nowrap whitespace-pre">Upload</p>
    </div>
  );
}
